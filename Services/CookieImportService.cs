...
namespace ZIVA_Prototype.Services
{
    ...
    {
        public List<BrowserCookieEntry> LoadFromCookieDatabase(string filePath)
        {
            ...
            while (reader.Read())
            {
                ...
                // Chrome encrypted_value is a BLOB
                ...
                // Chrome timestamps: microseconds since 1601-01-01 (like visit_time)
        ...
        private DateTime FromChromeUtc(long chromeTime)
        {
            ...
            return DateTime.UnixEpoch
                .AddSeconds(-11644473600)     // difference between 1601 and 1970
